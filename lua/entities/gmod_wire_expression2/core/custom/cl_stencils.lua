...
descriptions["stencilCount"] = "Returns the number of stencils the owner of the chip has created."
descriptions["stencilCount(e)"] = "Returns the number of stencils ply has created."
